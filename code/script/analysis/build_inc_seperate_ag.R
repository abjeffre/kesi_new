...
sec[grepl("kibarua ya nazi", dp$type)] <- "argroforestry"
sec[grepl("kuchuma nazi", dp$type)] <- "argroforestry"
sec[grepl("kuuza mazao", dp$type)] <- "agriculture"
sec[grepl("kusagisha nafaka", dp$type)] <- "agriculture"

# Seperate out rice
sec[grepl("ag_main", dp$type) & dp$subtype == "mpunga"] <- "rice"

# Seperate out rice
sec[grepl("ag_main", dp$type) & dp$subtype == "viazi vitamu"] <- "sweet_potato" 
